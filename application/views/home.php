                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="form-control form-select">
                                                ...
                                                <option>Lessons for Teen Classes</option>
                                                <option>Lessons for Adult Classes</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                ...
                <div class="row align-items-center ">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="500ms">
                        <div class="d-flex mb-4 gap-4 worksPnl">
                            <div>
                                <img src="<?= base_url() ?>assets/images/icon/stearing.png"/>
                            </div>
                            <div>
                        ...
                        <div class="d-flex mb-4 gap-4 worksPnl">
                            <div>
                                <img src="<?= base_url() ?>assets/images/icon/car.png"/>
                            </div>
                            <div>
                        ...
                        <div class="d-flex mb-1 gap-4 worksPnl">
                            <div>
                                <img src="<?= base_url() ?>assets/images/icon/idcard.png"/>
                            </div>
                            <div>
                ...
                <div class="row g-4">
                    <div class="col-lg-6  wow fadeInUp">
                        <div class="courseBlock">
                            <div class="courseBlockcontent">
                                <img src="<?= base_url() ?>assets/images/serviceicon/serv-01.png" class="courblockicon"/>
                                <h2><a href="#">Course Name</a></h2>
                                <p>Course Week: <span>4</span></p>
                                <p>Classes per Week: <span>3</span></p>
                                <p>Price: <span>$ 500</span></p>
                                <div class="mt-3">
                                    <a href="#" class="enrollbtn">Enroll Now</a>
                                </div>
                            </div>
                            <div class="courseImg">
                                <img src="<?= base_url() ?>assets/images/serv-bg-01.jpg"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6  wow fadeInUp">
                    ...
                    <div class="col-lg-6  wow fadeInUp">
                        <div class="courseBlock">
                            ...
                            <div class="courseImg">
                                <img src="<?= base_url() ?>assets/images/serv-bg-03.jpg"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6  wow fadeInUp">
                        <div class="courseBlock">
                            ...
                            <div class="courseImg">
                                <img src="<?= base_url() ?>assets/images/serv-bg-04.jpg"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6  wow fadeInUp">
                        <div class="courseBlock">
                            ...
                            <div class="courseImg">
                                <img src="<?= base_url() ?>assets/images/serv-bg-05.jpg"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6  wow fadeInUp">
        ...
        <section class="downloadBox">
            <div class="container">
                <div class="downloadapp" style="background-image: url(<?= base_url() ?>assets/images/appbg.png);">
